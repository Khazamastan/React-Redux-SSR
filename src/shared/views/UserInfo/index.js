...
const Location = () => {
    return (<div className="pr-20">
        <div className="text-bold text-black title-small border-bottom-1 pb-20 mb-20">Location</div>
...
const Hours = () => {
    return <div className="pl-20">
        <div className="text-bold text-black title-small border-bottom-1 pb-20 mb-20">Today's Hours</div>
